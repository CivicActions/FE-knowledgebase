...
This knowledge base is built using [Gatsby](https://www.gatsbyjs.org/) and [Strapi](https://strapi.io/). All of the content is maintained by the CivicActions frontend engineers group.
...
1.  **Open the source code and start editing!**
    ...
    *Note: You'll also see a second link: [http://localhost:8000/___graphql](http://localhost:8000/___graphql). This is a tool you can use to experiment with querying your data. Learn more about using this tool in the [Gatsby tutorial](https://www.gatsbyjs.org/tutorial/part-five/#introducing-graphiql).*
